	...
	*camsys_dev)
{
	...
	//victor	extdev->fl.ext_fsh_dev =
	//victor		camsys_register_ext_fsh_dev(&devio->fl);
...
//victor		if (extdev->fl.ext_fsh_dev != NULL) {
	//victor		camsys_deregister_ext_fsh_dev(extdev->fl.ext_fsh_dev);
		//victor}
...
//victor	camsys_init_ext_fsh_module();
...
//victor		camsys_deinit_ext_fsh_module();

...
{
//v	struct rk29camera_gpio_res *res = NULL;
//v	struct rkcamera_platform_data *new_cam_dev = NULL;
//v	struct rk29camera_platform_data* plat_data = &rk_camera_platform_data;
	int ret = RK29_CAM_IO_SUCCESS;//v ,i = 0;
//v	struct soc_camera_desc *dev_icl = NULL;
//v	struct rkcamera_platform_data *new_camera;
	debug_printk("/$$$$$$$$$$$$$$$$$$$$$$//n Here I am: %s:%i-------%s()/n", __FILE__, __LINE__, __FUNCTION__);
/*victor
	if (res == NULL) {
		new_camera = new_camera_head;
